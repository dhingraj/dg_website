        ...
        <div className="relative container-max px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-white/60 max-w-2xl leading-relaxed">
              Ready to transform your operations? Let&apos;s discuss how DG
              Micropronix can deliver the right solutions for your business.
            </p>
          </motion.div>
        </div>
      </section>
              ...
              <div className="p-6 rounded-2xl bg-white border border-gray-100 shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="text-xs text-navy-500/40 font-medium">
                        Phone
                      </p>
                      <p className="text-sm font-semibold text-navy-500 group-hover:text-accent-600 transition-colors">
                        {companyInfo.phone}
                      </p>
                    </div>
                  </a>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-sm font-semibold text-navy-500 hover:text-accent-600 transition-colors"
                      >
                        www.dgmpl.com
                      </a>
                    </div>
              ...
              {companyInfo.offices.map((office, i) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-navy-500 mb-1">
                        {office.type}
                      </h4>

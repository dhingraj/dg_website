    ...
    <>
        ...
        <div className="relative container-max px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-sm text-white/60 max-w-2xl leading-relaxed">
              200+ projects delivered across multiple states, serving India's largest industrial organizations with excellence.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-max">
          ...
          {/* Results count */}
          <p className="text-xs text-navy-500/40 mb-4">
          ...
          {filtered.length === 0 && (
            <div className="text-center py-12 text-navy-500/40">
              <p className="text-base font-medium">No projects match the selected filters.</p>
